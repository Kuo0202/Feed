...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    private func makeSUT(url: URL = URL(string: "Https://a-nogivenurl.com")!, file: StaticString = #filePath, line: UInt = #line) -> (sut: RemoteFeedLoader, client: HTTPClientSpy) {
        let client = HTTPClientSpy()
    ...
    private func trackForMemoryLeaks(_ instance: AnyObject, file: StaticString = #filePath, line: UInt = #line) {
        addTeardownBlock { [weak instance] in
            XCTAssertNil(instance, "Instance should have been deallocated. Potential mamory leak.", file: file, line: line)
        }
    }
